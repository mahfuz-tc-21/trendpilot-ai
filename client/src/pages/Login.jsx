  ...
  return (
    <div className="space-y-6">
      ...
      <div className="text-center space-y-4">
        ...
        <div className="space-y-1.5">
          ...
          <p className="text-xs text-zinc-450">
            Sign in to continue to your TrendPilot AI dashboard
          </p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 text-left">
        {/* Email */}
        <div className="space-y-1.5">
          <label className="block text-xs font-semibold text-zinc-350">
            Email address
          </label>
          <div className="relative">
            ...
            <input
              ...
              disabled={isLoading}
              className={`w-full h-10.5 pl-10 pr-3.5 rounded-xl bg-zinc-900/40 border text-sm text-zinc-100 placeholder-zinc-600 focus:outline-none focus:border-indigo-500 transition-colors ${
        ...
        <div className="flex items-center justify-between text-xs pt-1 select-none">
          <label className="flex items-center gap-2 text-zinc-400 cursor-pointer font-medium">
            <input
              type="checkbox"
              className="rounded border-zinc-800 bg-zinc-900 text-indigo-600 focus:ring-indigo-500 focus:ring-offset-zinc-950 cursor-pointer h-4 w-4"
            />
            Remember me
          </label>
          <span className="text-indigo-400 hover:text-indigo-350 hover:underline cursor-not-allowed font-medium" title="Forgot Password functionality coming soon">
            Forgot password?
          </span>
        </div>
      ...
      <div className="text-center pt-2">
        <p className="text-xs text-zinc-500">
          ...
          <Link to="/register" className="text-indigo-400 hover:text-indigo-350 hover:underline font-bold transition-colors">
            Create account
          </Link>
        </p>
      </div>
