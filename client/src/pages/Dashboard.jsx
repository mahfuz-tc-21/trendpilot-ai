      ...
      <div className="space-y-8 text-left">
        ...
        <div className="p-16 text-center border border-zinc-800 bg-zinc-900/10 rounded-3xl space-y-4 max-w-xl mx-auto">
          ...
          <div className="pt-2 flex justify-center gap-3">
            ...
            <button onClick={() => navigate("/competitors")} className="px-4 py-2 bg-zinc-900 border border-zinc-800 hover:border-zinc-750 text-xs font-bold text-zinc-300 rounded-xl transition-colors">
              Add Competitors
            </button>
          </div>
        </div>
  ...
  return (
    <div className="space-y-8 text-left">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-5">
        <div className="rounded-2xl border border-zinc-800 bg-zinc-900/10 p-5 flex flex-col justify-between h-28 hover:border-zinc-800 transition-colors">
            ...
            {db.recentRecommendations?.length === 0 ? (
              ...
              <div className="space-y-3">
                {db.recentRecommendations.map((r) => (
                  <div key={r.id} className="p-4 rounded-2xl border border-zinc-800 bg-zinc-950/40 flex items-center justify-between gap-4">
                    ...
                    <div className="flex items-center gap-4 flex-shrink-0">
                      <div className="text-right">
                        <span className="text-[9px] text-zinc-500 block font-bold uppercase">Opp Score</span>
                ...
                {db.recentScrapes.map((item) => {
                  ...
                  return (
                    <div
                      ...
                      className="p-4 rounded-2xl border border-zinc-800 bg-zinc-950/40 hover:border-indigo-500/50 hover:bg-zinc-900/20 transition-all flex items-center justify-between gap-4 cursor-pointer text-left"
                    >
