      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        ...
        <div>
          ...
          <input
            ...
            disabled={isLoading}
            className={`w-full h-10 px-3 rounded-xl bg-zinc-900/80 border text-sm text-zinc-100 placeholder-zinc-600 focus:outline-none focus:border-indigo-500 transition-colors ${errors.name ? "border-rose-500" : "border-zinc-800"
              }`}
            {...register("name")}
          />
          {errors.name && (
